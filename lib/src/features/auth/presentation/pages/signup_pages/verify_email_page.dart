                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style:
                                AppTextStyles.urbanistFont34Grey800SemiBold1_2,
                          ),
                          verticalSpace(12),
                          RichText(
                            text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                    text: AuthStrings.verificationEmailSent),
                                TextSpan(
                                  text: ' ${state.signupEmail ?? ''} ',
                                  style: AppTextStyles
                                      .urbanistFont15Grey700SemiBold1_33,
                                ),
                                TextSpan(
                                    text: AuthStrings.unlessAlreadyHaveAccount),
                              ],
                            ),
                          ),
                          verticalSpace(24),
                          Row(
                            children: [
                              Text(
                                state.signupEmail ?? '',
                                style: AppTextStyles
                                    .urbanistFont16Grey800Regular1_3,
                              ),
                              horizontalSpace(16),
                              TextButton(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ResendTimerButton(
                          ...
                          formatCountdownTime: SignupCubit.formatCountdownTime,
                        ),
